    ...
    >
     ...
     <template>
       ...
       <ul class="navbar-nav mr-auto">
         ...
         <li class="nav-item">
           <nuxt-link to="/AI-sensing-dashboard" class="nav-link">
             <span class="nav-link-inner--text">AI Sensing Dashboard</span>
           </nuxt-link>
         </li>
         <li class="nav-item">
           <nuxt-link to="/login" class="nav-link">
             <span class="nav-link-inner--text">Dashboard Report</span>
           </nuxt-link>
         </li>
